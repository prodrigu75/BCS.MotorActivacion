<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="BCS.MotorActivacion.WebPresentationLayer.Account.OpenAuthProviders" %>
